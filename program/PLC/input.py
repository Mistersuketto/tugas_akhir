...
def main() -> None:
    ...
    response = client.memory_area_write("CIO10.8", b"\x00")
    response = client.memory_area_write("CIO10.9", b"\x00")
    response = client.memory_area_write("CIO10.10", b"\x00")
    response = client.memory_area_write("CIO10.11", b"\x00")
    response = client.memory_area_write("CIO10.12", b"\x00")
    response = client.memory_area_write("CIO10.13", b"\x00")
    response = client.memory_area_write("CIO10.14", b"\x00")
    response = client.memory_area_write("CIO10.15", b"\x00")
    ...
    # response = client.memory_area_write("CIO10.8", b"\x01")
    # response = client.memory_area_write("CIO10.9", b"\x01")
    # response = client.memory_area_write("CIO10.10", b"\x01")
    # response = client.memory_area_write("CIO10.11", b"\x01")
    # response = client.memory_area_write("CIO10.12", b"\x01")
    # response = client.memory_area_write("CIO10.13", b"\x01")
    # response = client.memory_area_write("CIO10.14", b"\x01")
    # response = client.memory_area_write("CIO10.15", b"\x01")
