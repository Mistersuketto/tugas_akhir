...
# Buka webcam dari opencv
cap = cv2.VideoCapture(0)

# Definisikan rentang HSV untuk setiap warna Rubik
color_ranges = {
    'Merah': [([155, 50, 130], [175, 255, 255])],
    'Oranye': [([11, 120, 70], [23, 255, 255])],
    'Kuning': [([24, 90, 150], [38, 255, 255])],
    'Hijau': [([40, 50, 50], [85, 255, 255])],
    'Biru': [([90, 80, 50], [115, 255, 255])],
    'Putih': [([105, 0, 131], [121, 255, 255])]
}
